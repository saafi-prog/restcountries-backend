 ...
 * \q
 */
INSERT INTO countries (name, capital, area, population, flag, latitude, longitude) VALUES
    ('Republic of Belarus','Minsk',207600, 9398861,'https://flagcdn.com/w320/by.png',53.9,27.57),
    ('Slovak Republic','Bratislava', 49037,5458827,'https://flagcdn.com/w320/lv.png',48.15,17.12),
    ('Republic of Latvia','Riga',64559,1901548,'https://flagcdn.com/w320/gi.png',56.95, 24.1),
    ('Gibraltar', 'Gibraltar',64559,33691,'https://flagcdn.com/w320/rs.png' ,36.13,-5.35),
    ('Republic of Serbia','Belgrade',88361,6908224,'https://flagcdn.com/w320/ax.png',44.83,20.5),
    ('Aland Islands','Mariehamn',1580,29458,'https://flagcdn.com/w320/gb.png',60.12,19.9),
    ('United Kingdom of Great Britain and Northern Ireland','London',242900,67215293,'https://flagcdn.com/w320/ba.png',51.5,-0.08),
    ('Bosnia and Herzegovina','Sarajevo',51209,3280815,'https://flagcdn.com/w320/ba.png',43.8,18.42),
    ('Vatican City State','Vatican City',0.44,451,'https://flagcdn.com/w320/li.png',41.9,12.45),
    ('Principality of Liechtenstein','Vaduz',160,38137,'https://flagcdn.com/w320/me.png', 47.13,9.52),
    ('Montenegro','Podgorica',13812,621718,'https://flagcdn.com/w320/sj.png',42.43,19.27),
    ('Svalbard og Jan Mayen','Longyearbyen',61022,2562,'https://flagcdn.com/w320/mk.png',78.0,20.0 ),
    ('Republic of North Macedonia','Skopje',25713,2077132,'https://flagcdn.com/w320/dk.png',41.83333333,22.0),
    ('Kingdom of Denmark','Copenhagen',43094,5831404,'https://flagcdn.com/w320/gr.png',55.67,12.58),
    ('Hellenic Republic','Athens',131990,10715549,'https://flagcdn.com/w320/ad.png',39.0,22.0),
    ('Principality of Andorra', 'Andorra', 468.0, 77265,'https://flagcdn.com/w320/ad.png',42.5,1.5),
	('Swiss Confederation', 'Bern',41284.0, 8654622, 'https://flagcdn.com/w320/ch.png',46.92,7.47),
    ('Portuguese Republic','Lisbon',92090,10305564,'https://flagcdn.com/w320/gg.png',38.72,-9.13),
    ('Bailiwick of Guernsey','St. Peter Port',78,62999,'https://flagcdn.com/w320/sm.png',49.45,-2.54),
    ('Republic of San Marino','City of San Marino',61,33938,'https://flagcdn.com/w320/md.png',43.94,12.45),
